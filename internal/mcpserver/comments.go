...
func registerCommentTools(s *mcp.Server, client *APIClient) {
	register(s, "cmstack_go_list_comments", "List comments",
	...
	register(s, "cmstack_go_approve_comment", "Approve a comment",
	...
	register(s, "cmstack_go_mark_comment_spam", "Mark a comment as spam",
